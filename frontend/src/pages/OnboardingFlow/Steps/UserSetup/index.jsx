...
const CHOICE_BUTTON_BASE_CLASSES =
  "min-w-[230px] h-11 p-4 rounded-[10px] border-2 justify-center items-center gap-[100px] inline-flex transition-all duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400/60";

const buildChoiceButtonClassName = ({ isActive = false, disabled = false }) => {
  if (disabled) {
    return `${CHOICE_BUTTON_BASE_CLASSES} text-theme-text-secondary border-theme-sidebar-border opacity-40 cursor-not-allowed`;
  }
  ...
  return `${activeClasses} ${CHOICE_BUTTON_BASE_CLASSES} hover:border-sky-400/70 hover:text-sky-400`;
};

export default function UserSetup({ setHeader, setForwardBtn, setBackBtn }) {
  const { t } = useTranslation();
  const [selectedOption, setSelectedOption] = useState("just_me");
  ...
  return (
    <>
      <Tooltip
        id="user-setup-disabled-option-tooltip"
        place="top"
        delayShow={200}
        ...
        <div className="flex flex-col border rounded-lg border-white/20 light:border-theme-sidebar-border p-8 items-center gap-y-4 w-full max-w-[600px]">
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
            <button
              ...
              className={buildChoiceButtonClassName({
                isActive: selectedOption === "just_me",
              })}
            >
            ...
            <div
              data-tooltip-id="user-setup-disabled-option-tooltip"
            ...
            >
              <button
                ...
                aria-disabled="true"
                className={buildChoiceButtonClassName({
                  isActive: selectedOption === "my_team",
                  disabled: true,
                })}
              >
                <div className="text-center text-sm font-bold">
        ...
        <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
          ...
          >
            <button
              ...
              aria-disabled="true"
              className={buildChoiceButtonClassName({
                isActive: enablePassword && itemSelected,
                disabled: true,
              })}
            >
              <div className="text-center text-sm font-bold">
