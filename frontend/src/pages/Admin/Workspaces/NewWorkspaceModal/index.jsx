...
export default function NewWorkspaceModal({ closeModal }) {
  ...
  const handleCreate = (e) => {
    setError(null);
    e.preventDefault();
    setError(ASSESSMENT_DISABLED_TOOLTIP);
  };
            ...
            <div className="flex justify-between items-center mt-6 pt-6 border-t border-theme-modal-border">
              ...
              >
                <button
                  type="button"
                  disabled
                  className="transition-all duration-300 bg-white text-black px-4 py-2 rounded-lg text-sm opacity-40 cursor-not-allowed pointer-events-none"
                >
                  Create workspace
                </button>
              </div>
