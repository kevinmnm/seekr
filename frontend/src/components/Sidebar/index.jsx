...
function NewWorkspaceButton({ user }) {
    ...
    <div className="flex gap-x-2 items-center justify-between">
      ...
      >
        <button
          ...
          disabled
          aria-disabled="true"
          className="flex flex-grow w-[75%] h-[44px] gap-x-2 py-[5px] px-4 bg-white rounded-lg text-sidebar justify-center items-center opacity-40 cursor-not-allowed pointer-events-none transition-all duration-300"
        >
...
function WorkspaceAndThreadTooltips() {
  return createPortal(
    <React.Fragment>
      ...
      />
      <Tooltip
        id={ASSESSMENT_DISABLED_TOOLTIP_ID}
        place="top"
        delayShow={200}
        className="tooltip !text-xs z-99"
      />
